...
//    if ($res['Mail'] == $email) {
        ...
        $body = 'Bonjour, vous avez oubliez votre mot de passe, cliquer sur le lien présent pour le réinitialiser : http://localhost/PROJET_DEVphp/projet_trans_web_dev/Workshop_B2/modif_password.php?token=' . $token . '';
